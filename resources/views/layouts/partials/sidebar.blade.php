            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                            <a href="/gerenciar-pessoa" class="waves-effect"><span>Pessoa</span></a>
                        </li>
                        @if(!$perfil_vol)
                        <li>
                            <a href="/gerenciar-entidade" class="waves-effect"><span>Entidade</span></a>
                        </li>
                        @endif
                        @if($perfil_adm)
                        <li>
                            <a href="/gerenciar-usuario" class="waves-effect"><span>Usuario</span></a>
                        </li>
                        @endif
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li>
                            <a href="/gerenciar-item-catalogo" class="waves-effect"><span>Item Catalogo</span></a>
                        </li>
                        <li>
                            <a href="/gerenciar-composicao" class="waves-effect"><span>Composição</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="/cad-cat-material" class="waves-effect"><span>Categoria Material</span></a>
                        </li>
                        @if($perfil_adm || $perfil_ger)
                            <li>
                                <a href="/cad-tipo-estoque" class="waves-effect"><span>Tipo Estoque</span></a>
                            </li>
                        @endif
                        @if(!$perfil_vol)
                            <li>
                                <a href="/deposito" class="waves-effect"><span>Depósito</span></a>
                            </li>
                            <li>
                                <a href="/localizador" class="waves-effect"><span>Localizador</span></a>
                            </li>
                            <li>
                                <a href="/cad-pagamento" class="waves-effect"><span>Pagamento</span></a>
                            </li>
                            <li>
                                <a href="/cad-valor-avariado" class="waves-effect"><span>Valor Item Avariado</span></a>
                            </li>
                        @endif
                        <li>
                            <a href="/cad-embalagem" class="waves-effect"><span>Embalagem</span></a>
                        </li>
                        <li>
                            <a href="/unidade-medida" class="waves-effect"><span>Unidade de Medida</span></a>
                        </li>
                        <li>
                            <a href="/cad-tipo-material" class="waves-effect"><span>Tipo de Material</span></a>
                        </li>
                        <li>
                            <a href="/marca" class="waves-effect"><span>Marca</span></a>
                        </li>
                        <li>
                            <a href="/tamanho" class="waves-effect"><span>Tamanho</span></a>
                        </li>
                        <li>
                            <a href="/cor" class="waves-effect"><span>Cor</span></a>
                        </li>
                        <li>
                        ...
                        @if(!$perfil_vol)
                            <li>
                                <a href="/cad-sit-doacao" class="waves-effect"><span>Situação Doação </span></a>
                            </li>
                        @endif
                    </ul>
                </li>
