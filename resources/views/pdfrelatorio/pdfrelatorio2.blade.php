...
<body>
 <div class="container-fluid" id="1" style="background:#ffffff;">
            <h4 class="card-title" class="card-title" style="font-size:20px; text-align: left; color: gray; font-family:calibri">INVENTÁRIO DE ESTOQUE COM FABRICANTE</h4>
                <div class="row">
                <h6 class="font-weight-bold" style="color: blue;  margin-left: 10px;">INVENTÁRIO DE ESTOQUE FABRICANTE - no dia <span class="badge badge-secondary">{{ \Carbon\Carbon::parse($data)->format('d/m/Y')}}</span> </h6>
                    <table class="table table-sm table-striped">
                        ...
                        <tbody>
                            ...
                            <tr style="text-align:center; font-size:10px">
                                ...
                                <td style="font-size: 8px;">{{ $rit->data ? date('d-m-Y', strtotime($rit->data)): '-' }}</td>
