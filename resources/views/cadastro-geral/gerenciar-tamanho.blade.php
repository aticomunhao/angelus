...
@section('title')Gerenciar tamanhos @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Cadastro de Tamanho</h4>
                    <hr>
                    <form class="form-horizontal mt-4" method="POST" action="/tamanho/inserir">
                    @csrf
                        <div class="form-group">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-4">
                                    <input class="form-control" type="text" id="tamanho" name="tamanho" required oninvalid="this.setCustomValidity('Campo requerido')">
                                </div>
                            </div>
