                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-hover table-dark"  style="font-size:15px;">
                            ...
                            {{-- @if($saidacat1->currentPage() === $saidacat1->lastPage()) --}}
                    ...
                    {{-- <div class="d-flex justify-content-center">{{$saidacat1->withQueryString()->links()}} --}}
                </div>
            </div>
        </div>
    </div>          
                ...
                <table class="table table-hover table-dark" style="font-size:15px;">
                    <tbody style="text-align:center; vertical-align:middle;">
                        <tr>
                            ...
                            <td style="text-align:left;">{{number_format($desconto,2,',','.')}}</td>
                        </tr>
                        ...
                        <tr class="table-success" style="color:#000; text-align:right;font-size:14px;font-weight:bold;">
                            ...
                            <td style="text-align:left;font-size:15px;">{{number_format($total3,2,',','.')}}</td>
                        </tr>
                    </tbody>
                </table>                                                   
            </div>
