            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- <p class="card-title-desc">Here are examples of <code class="highlighter-rouge">.form-control</code> applied to each textual HTML5 <code class="highlighter-rouge">&lt;input&gt;</code> <code class="highlighter-rouge">type</code>.</p>-->
                                <form class="form-horizontal mt-4" method="POST" action="route{{('/registrar-devolucao')}}">
                                @csrf
                                    <div class="container">
                                        <div id="divSubstituicao"></div>
                                        <div class="row align-items-center">
                                            <div class="col-sm">
                                                <label for="id_devolucao">ID Substituição</label>
                                            ...
                                            <label for="data_venda">Data</label>
                                                <input class="form-control" value="{{ \Carbon\carbon::now()->toDateTimeString() . PHP_EOL}}" type="text" name="data_venda" id="data_devolucao" placeholder="Data Devolução" readonly>
                                            </div>
                                            <div class="col-sm">
                            ...
                            <div id="divAddItem" style="display: none;">
                                ...
                                <br>
                                <div class="container" id="divDevolucaoItens">
                                    <div class="row">
