...
class GerenciarInventariosController extends Controller{
    ...
    public function fabrica(Request $request){
        ...
        $resultItens = $resultItens->orderBy('tcm.nome', 'asc','im.ref_fabricante', 'icm.nome', 'asc')->paginate(100);   
    
    
        return view('relatorios/inventario-fabricante', compact('nr_ordem', 'compra', 'categoria', 'item', 'data', 'resultCategorias', 'resultItens', 'total_itens', 'total_soma', 'itemmaterial', 'cod_fab'));
